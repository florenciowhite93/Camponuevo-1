...
function EspecieIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 137 105" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M111.797 24.8399C113.437 24.8399 114.767 23.5102 114.767 21.8699C114.767 20.2296 113.437 18.8999 111.797 18.8999C110.157 18.8999 108.827 20.2296 108.827 21.8699C108.827 23.5102 110.157 24.8399 111.797 24.8399Z" stroke="#2d5a27" strokeWidth="3.5"/>
    </svg>
  );
}
